...
function addResourceLinks(object, opts) {
  ...
  const resourceLink = hateoasLinks.buildResourceLink(opts.url, opts.collectionName, identifier);
  const collectionLink = hateoasLinks.buildCollectionLink(opts.url, opts.collectionName);
